    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linked_habit', models.OneToOneField(blank=True, limit_choices_to={'pleasant_habit': True}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='linked_to', to='habits.habit', verbose_name='Связанная привычка')),
